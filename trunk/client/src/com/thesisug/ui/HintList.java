...
public class HintList extends ListActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case CREATE_EVENT:
			...
			intent = new Intent(HintList.this, EditEvent.class);
		...
		case CREATE_TASK:
			// need to recreate intent to solve the case when user 
			// goes back and forth between edit-show
			intent = new Intent(HintList.this, EditTask.class);
			intent.putExtra("originator", 1);// CREATE_EVENT code in EditEvent
			startActivityForResult(intent, 0);
			break;
		case VOICE_INPUT:
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (item.get(ITEM_DATA) instanceof SingleEvent){
			...
			intent = new Intent(HintList.this, ShowEvent.class);
			...
			intent = new Intent(HintList.this, ShowTask.class);
			intent.putExtra("username", username);
			intent.putExtra("session", session);
