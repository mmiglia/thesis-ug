...
/**
 * Everytime the user wants to retrieve/add tasks, it saves in the local task
 * databases, and also to the 3rd party database (for future extension)
 */
public interface TaskInterface {
	 ...
	 * @param task SingleTask object from local database
	 ...
	 * @param userid unique UUID of the user
	 * @param oldTask old task object to be replaced
	 * @param newTask the new task object
	 * @return false if unsuccessful, 1 if successful
	 */
	public boolean updateTask(String userid, SingleTask oldTask, SingleTask newTask);
