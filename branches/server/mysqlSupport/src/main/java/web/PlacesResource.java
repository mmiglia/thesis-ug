...
public class PlacesResource {
    ...
    @POST
   	...
   	/*
   	@return null if the place is already entered in Place 
   			file or in the db
   	*/
   			...
   			@CookieParam("sessionid") String sessionid, Place place)
   	{
   		...
   		PlacesManager.getInstance().addPrivatePlace(userid, place.title,place.streetAddress,place.streetNumber,place.city);
   	}
