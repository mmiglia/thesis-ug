   ...
   //voteItem
	...
	{	
		...
		*/
		...
		selectQuery= "select * from Item_foundIn_Loc where Item='"+item+"' and Location='"+location+"'";
		System.out.println(selectQuery);
		
		qs=dbManager.customQuery(conn, selectQuery);
		rs=(ResultSet)qs.customQueryOutput;
		SingleItemLocation itemLocationToReturn = null;
		try{
			//Creating SingleItemLocation object from data inserted into the database
			if(rs.next()){
   ...
   //voteAction
	...
	{	System.out.println("Sono in OntologyDatabase");
		...
		*/
		...
		selectQuery= "select * from Action_foundIn_Loc where Action='"+action+"' and Location='"+location+"'";
		System.out.println(selectQuery);
  ...
  //voteLocation
	...
	{	System.out.println("Sono in OntologyDatabase");
		...
		*/
		...
		selectQuery= "select * from Loc_foundIn_Loc where Location1='"+location1+"' and Location2='"+location2+"'";
		System.out.println(selectQuery);
