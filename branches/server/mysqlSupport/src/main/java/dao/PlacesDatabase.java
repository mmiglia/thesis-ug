...
public enum PlacesDatabase {
               ...
               try{
                       while(rs.next()){
                               ...
                               publicPlacesList.add(
                                               new Place(title,lat,lng,streetAddress,streetNumber,city)                                        
                                       );
                       }
       ...
       public static void addPrivatePlace( String userID,  String title,  String streetAddress,  String streetNumber,  String city ){
